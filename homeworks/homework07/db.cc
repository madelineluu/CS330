...
// Not an actual student added
SNode::SNode() : Node(0), first(""), last(""), age(0) {}

// Constructor
// TODO: Implement this
// BASIC function header is provided for so that the code will compile
// The actual function header may be different 
SNode::SNode(string f_, string l_, unsigned int a_) : Node(num_students++), first(f_), last(l_), age(a_) {}
