/*************************************
CS 330 Lab 10: Operator overloading, namespaces, and static members
...
namespace Mem {
  ...
  public:
    ...
    IntQueue& operator<<(int value) { Enqueue(value); return *this; }
    IntQueue& operator>>(int value) { value = Dequeue(); return *this; }
  };
